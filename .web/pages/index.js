...
<Code sx={{"fontSize": "1em"}}>{`test_pynecone/test_pynecone.py`}</Code></Box>
<NextLink passHref={true}
href="https://pynecone.io/docs/getting-started/introduction"><Link sx={{"border": "0.1em solid", "padding": "0.5em", "borderRadius": "0.5em", "_hover": {"color": "rgb(107,99,246)"}}}>{`Check out our docs!`}</Link></NextLink></VStack>
